return {
  ...
  keys = {
    ...
    { "<leader>db", ":DiffviewOpen origin/HEAD...HEAD<CR>", desc = "Diff against origin/HEAD" },
    { "<leader>dh", ":DiffviewFileHistory<CR>", desc = "File history (all)" },
    { "<leader>df", ":DiffviewFileHistory %<CR>", desc = "File history (current)" },
    { "<leader>dc", ":DiffviewClose<CR>", desc = "Close diffview" },
    { "<leader>dt", ":DiffviewToggleFiles<CR>", desc = "Toggle diffview files" },
